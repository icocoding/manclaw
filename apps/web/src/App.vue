...
const naiveThemeOverrides = computed(() => {
  if (currentTheme.value === 'harbor') {
    return {
      common: {
        ...
        warningColor: '#e6a85f',
        warningColorHover: '#f0b974',
        warningColorPressed: '#cb8f49',
        warningColorSuppl: '#ffd8a6',
      ...
      Button: {
        colorWarning: '#e6a85f',
        colorHoverWarning: '#f0b974',
        colorPressedWarning: '#cb8f49',
        colorFocusWarning: '#f0b974',
        colorDisabledWarning: '#e6a85f',
        textColorWarning: '#08201e',
        textColorHoverWarning: '#08201e',
        textColorPressedWarning: '#08201e',
        textColorFocusWarning: '#08201e',
        textColorDisabledWarning: '#08201e',
        borderWarning: '1px solid #e6a85f',
        borderHoverWarning: '1px solid #f0b974',
        borderPressedWarning: '1px solid #cb8f49',
        borderFocusWarning: '1px solid #f0b974',
        borderDisabledWarning: '1px solid #e6a85f',
      },
      Select: {
        peers: {
          InternalSelection: {
  ...
  return {
    common: {
      ...
      warningColor: '#c97b3f',
      warningColorHover: '#da9154',
      warningColorPressed: '#aa6230',
      warningColorSuppl: '#ffd3a0',
    ...
    Button: {
      colorWarning: '#c97b3f',
      colorHoverWarning: '#da9154',
      colorPressedWarning: '#aa6230',
      colorFocusWarning: '#da9154',
      colorDisabledWarning: '#c97b3f',
      textColorWarning: '#24180d',
      textColorHoverWarning: '#24180d',
      textColorPressedWarning: '#24180d',
      textColorFocusWarning: '#24180d',
      textColorDisabledWarning: '#24180d',
      borderWarning: '1px solid #c97b3f',
      borderHoverWarning: '1px solid #da9154',
      borderPressedWarning: '1px solid #aa6230',
      borderFocusWarning: '1px solid #da9154',
      borderDisabledWarning: '1px solid #c97b3f',
    },
    Select: {
      peers: {
        InternalSelection: {
